...
def do_preprocessing(df_train:pd.DataFrame, df_test:pd.DataFrame, drop_cols:list, encoding_cols:list, model_name:str):
    '''
    모델 학습 전 데이터 전처리 함수
    '''
    ...
    # 3. encoding
    df_train, df_test = do_encoding(df_train, df_test, encoding_cols, model_name)
