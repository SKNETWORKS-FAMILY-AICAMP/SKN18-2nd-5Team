...
if not df.empty:
    # --- 1. 결측치 처리 (기존과 동일) ---
    df.drop(['reservation_status', 'reservation_status_date', 'required_car_parking_spaces'], axis=1, inplace=True, errors='ignore')
    ...
    df.drop(['children', 'babies'], axis=1, inplace=True, errors='ignore')
